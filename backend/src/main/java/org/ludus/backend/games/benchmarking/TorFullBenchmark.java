...
/**
 * Run the algorithms on Tor graphs with both the integer algorithm, as well
 * as the double algorithm using two different values of epsilon.
 *
 * @author Bram van der Sanden
 */
public class TorFullBenchmark extends Benchmark {
    ...
    public void run(Integer numberOfIterations,
        ...
        file.printf("%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s\n",
                "N", "maxWeight1", "maxWeight2",
    ...
    private void runAlgorithmsTor(Integer size,
        ...
        file.printf("%d,%d,%d,%f,%f,%f,%f,%f,%f,%f,%f,%f\n",
                size, maxWeight1, maxWeight2,
                piSec, egSec, zpSec,
